...
export const canisterId = process.env.FAUCET_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./faucet.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the faucet canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./faucet.did.js")._SERVICE>}
 */
